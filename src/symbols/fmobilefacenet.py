...
def get_symbol_v2(num_classes, **kwargs):
    print('start get_symbol_v2')
    global bn_mom
    bn_mom = kwargs.get('bn_mom', 0.9)
    wd_mult = kwargs.get('wd_mult', 1.)
    version_output = kwargs.get('version_output', 'GNAP')
    ...
    conv_34 = DResidual(conv_3, num_out=128, kernel=(3, 3), stride=(2, 2), pad=(1, 1), num_group=256, name="dconv_34")
    conv_4 = Residual(conv_34, num_block=6, num_out=128, kernel=(3, 3), stride=(1, 1), pad=(1, 1), num_group=256, name="res_4")
    conv_45 = DResidual(conv_4, num_out=256, kernel=(3, 3), stride=(2, 2), pad=(1, 1), num_group=512, name="dconv_45")
    conv_5 = Residual(conv_45, num_block=2, num_out=256, kernel=(3, 3), stride=(1, 1), pad=(1, 1), num_group=512, name="res_5")
    conv_6_sep = Conv(conv_5, num_filter=512, kernel=(1, 1), pad=(0, 0), stride=(1, 1), name="conv_6sep")

    fc1 = symbol_utils.get_fc1(conv_6_sep, num_classes, fc_type)
    return fc1

def get_symbol_v3(num_classes, **kwargs):
    print('start get_symbol_v3')
    global bn_mom
    bn_mom = kwargs.get('bn_mom', 0.9)
    wd_mult = kwargs.get('wd_mult', 1.)
    version_output = kwargs.get('version_output', 'GNAP')
    ...
    conv_1 = Conv(data, num_filter=64, kernel=(3, 3), pad=(1, 1), stride=(2, 2), name="conv_1")
    conv_2_dw = Conv(conv_1, num_group=64, num_filter=64, kernel=(3, 3), pad=(1, 1), stride=(1, 1), name="conv_2_dw")
    conv_23 = DResidual(conv_2_dw, num_out=128, kernel=(3, 3), stride=(2, 2), pad=(1, 1), num_group=256, name="dconv_23")
    conv_3 = Residual(conv_23, num_block=4, num_out=128, kernel=(3, 3), stride=(1, 1), pad=(1, 1), num_group=256, name="res_3")
    conv_34 = DResidual(conv_3, num_out=256, kernel=(3, 3), stride=(2, 2), pad=(1, 1), num_group=512, name="dconv_34")
    conv_4 = Residual(conv_34, num_block=6, num_out=256, kernel=(3, 3), stride=(1, 1), pad=(1, 1), num_group=512, name="res_4")
    conv_45 = DResidual(conv_4, num_out=256, kernel=(3, 3), stride=(2, 2), pad=(1, 1), num_group=1024, name="dconv_45")
    conv_5 = Residual(conv_45, num_block=2, num_out=256, kernel=(3, 3), stride=(1, 1), pad=(1, 1), num_group=512, name="res_5")
    conv_6_sep = Conv(conv_5, num_filter=512, kernel=(1, 1), pad=(0, 0), stride=(1, 1), name="conv_6sep")
...
def get_symbol_v4(num_classes, **kwargs):
    print('start get_symbol_v4')
    global bn_mom
    bn_mom = kwargs.get('bn_mom', 0.9)
    wd_mult = kwargs.get('wd_mult', 1.)
    version_output = kwargs.get('version_output', 'GNAP')
    ...
    conv_23 = DResidual(conv_2, num_out=128, kernel=(3, 3), stride=(2, 2), pad=(1, 1), num_group=256, name="dconv_23")
    conv_3 = Residual(conv_23, num_block=4, num_out=128, kernel=(3, 3), stride=(1, 1), pad=(1, 1), num_group=256, name="res_3")
    conv_34 = DResidual(conv_3, num_out=256, kernel=(3, 3), stride=(2, 2), pad=(1, 1), num_group=512, name="dconv_34")
    conv_4 = Residual(conv_34, num_block=6, num_out=256, kernel=(3, 3), stride=(1, 1), pad=(1, 1), num_group=512, name="res_4")
    conv_45 = DResidual(conv_4, num_out=256, kernel=(3, 3), stride=(2, 2), pad=(1, 1), num_group=1024, name="dconv_45")
...
def get_symbol_v5(num_classes, **kwargs):
    print('start get_symbol_v5')
    global bn_mom
    bn_mom = kwargs.get('bn_mom', 0.9)
    wd_mult = kwargs.get('wd_mult', 1.)
    version_output = kwargs.get('version_output', 'GNAP')
    ...
    conv_1 = Conv(data, num_filter=64, kernel=(3, 3), pad=(1, 1), stride=(2, 2), name="conv_1")
    conv_2_dw = Conv(conv_1, num_group=64, num_filter=64, kernel=(3, 3), pad=(1, 1), stride=(1, 1), name="conv_2_dw")
    conv_23 = SResidual(conv_2_dw, num_out=128, kernel=(3, 3), stride=(2, 2), pad=(1, 1), num_group=256, name="dconv_23")
    conv_3 = Residual(conv_23, num_block=4, num_out=128, kernel=(3, 3), stride=(1, 1), pad=(1, 1), num_group=256, name="res_3")
...
def get_symbol_v6(num_classes, **kwargs):
...
def get_symbol_v7(num_classes, **kwargs):
    print('start get_symbol_v7')
    global bn_mom
    bn_mom = kwargs.get('bn_mom', 0.9)
    wd_mult = kwargs.get('wd_mult', 1.)
    version_output = kwargs.get('version_output', 'GNAP')
    ...
    conv_23 = SResidual(conv_2, num_out=128, kernel=(3, 3), stride=(2, 2), pad=(1, 1), num_group=256, name="dconv_23")
    conv_3 = Residual(conv_23, num_block=4, num_out=128, kernel=(3, 3), stride=(1, 1), pad=(1, 1), num_group=256, name="res_3")
    conv_34 = SResidual(conv_3, num_out=256, kernel=(3, 3), stride=(2, 2), pad=(1, 1), num_group=1024, name="dconv_34")
    conv_4 = Residual(conv_34, num_block=6, num_out=256, kernel=(3, 3), stride=(1, 1), pad=(1, 1), num_group=512, name="res_4")
    conv_45 = SResidual(conv_4, num_out=256, kernel=(3, 3), stride=(2, 2), pad=(1, 1), num_group=1024, name="dconv_45")
    conv_5 = Residual(conv_45, num_block=3, num_out=256, kernel=(3, 3), stride=(1, 1), pad=(1, 1), num_group=512, name="res_5")
    conv_6_sep = Conv(conv_5, num_filter=512, kernel=(1, 1), pad=(0, 0), stride=(1, 1), name="conv_6sep")
...
def get_symbol_v8(num_classes, **kwargs):
    print('start get_symbol_v8')
    global bn_mom
    bn_mom = kwargs.get('bn_mom', 0.9)
    wd_mult = kwargs.get('wd_mult', 1.)
    version_output = kwargs.get('version_output', 'GNAP')
...
def get_symbol_v9(num_classes, **kwargs):
    print('start get_symbol_v9')
    global bn_mom
    bn_mom = kwargs.get('bn_mom', 0.9)
    wd_mult = kwargs.get('wd_mult', 1.)
    version_output = kwargs.get('version_output', 'GNAP')
