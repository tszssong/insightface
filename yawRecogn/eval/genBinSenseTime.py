...
f_list = []
p_list = []
for line in open(args.data_dir+'/protocol/frontal_list_nonli_new.txt', 'r'):
  pp+=1
  if pp%100==0:
    print('processing', pp)
...
for line in open(args.data_dir+'/protocol/profile_list_nonli_new.txt', 'r'):
  pp+=1
  if pp%100==0:
    print('processing', pp)
  line = line.strip().split()
